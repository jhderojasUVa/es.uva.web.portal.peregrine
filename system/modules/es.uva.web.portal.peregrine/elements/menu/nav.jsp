...
<ul class="nav nav-pills nav-stacked">
	<c:forEach items="${nav.items}" var="elem">
		<li role="presentation" <c:choose><c:when test="${fn:startsWith(cms.requestContext.uri, elem.resourceName)}">class="active"</c:when><c:otherwise>class=""</c:otherwise></c:choose> >
